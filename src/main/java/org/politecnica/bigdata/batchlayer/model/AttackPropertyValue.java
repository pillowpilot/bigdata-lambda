...
public class AttackPropertyValue extends org.apache.thrift.TUnion<AttackPropertyValue, AttackPropertyValue._Fields> {
  ...
  private static final org.apache.thrift.protocol.TField NKILLS_FIELD_DESC = new org.apache.thrift.protocol.TField("nkills", org.apache.thrift.protocol.TType.I64, (short)3);

  /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    DATE((short)1, "date"),
    COORDINATES((short)2, "coordinates"),
    NKILLS((short)3, "nkills");
  ...
  static {
    ...
    tmpMap.put(_Fields.COORDINATES, new org.apache.thrift.meta_data.FieldMetaData("coordinates", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT        , "Coordinates")));
  ...
  protected void checkType(_Fields setField, java.lang.Object value) throws java.lang.ClassCastException {
    switch (setField) {
      case DATE:
        ...
        throw new java.lang.ClassCastException("Was expecting value of type Date for field 'date', but got " + value.getClass().getSimpleName());
      case COORDINATES:
        if (value instanceof Coordinates) {
          break;
        }
        throw new java.lang.ClassCastException("Was expecting value of type Coordinates for field 'coordinates', but got " + value.getClass().getSimpleName());
      case NKILLS:
  ...
  public Coordinates getCoordinates() {
    if (getSetField() == _Fields.COORDINATES) {
      ...
      throw new java.lang.RuntimeException("Cannot get field 'coordinates' because union is currently set to " + getFieldDesc(getSetField()).name);
    }
  }
