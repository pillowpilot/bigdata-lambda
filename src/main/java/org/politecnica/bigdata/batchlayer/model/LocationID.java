...
public class LocationID extends org.apache.thrift.TUnion<LocationID, LocationID._Fields> {
	...
	protected void checkType(_Fields setField, java.lang.Object value) throws java.lang.ClassCastException {
		...
		case ID:
			...
			throw new java.lang.ClassCastException("Was expecting value of type java.lang.Long for field 'id', but got "
	...
	public long getId() {
		if (getSetField() == _Fields.ID) {
			...
			throw new java.lang.RuntimeException(
					"Cannot get field 'id' because union is currently set to " + getFieldDesc(getSetField()).name);
		}
	}
