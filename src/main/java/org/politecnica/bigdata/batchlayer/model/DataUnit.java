...
public class DataUnit extends org.apache.thrift.TUnion<DataUnit, DataUnit._Fields> {
  ...
  private static final org.apache.thrift.protocol.TField ATTACK_PROPERTY_FIELD_DESC = new org.apache.thrift.protocol.TField("attack_property", org.apache.thrift.protocol.TType.STRUCT, (short)1);
  private static final org.apache.thrift.protocol.TField WEAPON_PROPERTY_FIELD_DESC = new org.apache.thrift.protocol.TField("weapon_property", org.apache.thrift.protocol.TType.STRUCT, (short)2);
  private static final org.apache.thrift.protocol.TField LOCATION_PROPERTY_FIELD_DESC = new org.apache.thrift.protocol.TField("location_property", org.apache.thrift.protocol.TType.STRUCT, (short)3);
  private static final org.apache.thrift.protocol.TField ATTACK_AT_EDGE_FIELD_DESC = new org.apache.thrift.protocol.TField("attack_at_edge", org.apache.thrift.protocol.TType.STRUCT, (short)4);
  private static final org.apache.thrift.protocol.TField WEAPON_USED_EDGE_FIELD_DESC = new org.apache.thrift.protocol.TField("weapon_used_edge", org.apache.thrift.protocol.TType.STRUCT, (short)5);

  /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ATTACK_PROPERTY((short)1, "attack_property"),
    WEAPON_PROPERTY((short)2, "weapon_property"),
    LOCATION_PROPERTY((short)3, "location_property"),
    ATTACK_AT_EDGE((short)4, "attack_at_edge"),
  ...
  static {
    ...
    tmpMap.put(_Fields.ATTACK_PROPERTY, new org.apache.thrift.meta_data.FieldMetaData("attack_property", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT        , "AttackProperty")));
    tmpMap.put(_Fields.WEAPON_PROPERTY, new org.apache.thrift.meta_data.FieldMetaData("weapon_property", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT        , "WeaponProperty")));
    tmpMap.put(_Fields.LOCATION_PROPERTY, new org.apache.thrift.meta_data.FieldMetaData("location_property", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT        , "LocationProperty")));
    tmpMap.put(_Fields.ATTACK_AT_EDGE, new org.apache.thrift.meta_data.FieldMetaData("attack_at_edge", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT        , "AttackAtEdge")));
    tmpMap.put(_Fields.WEAPON_USED_EDGE, new org.apache.thrift.meta_data.FieldMetaData("weapon_used_edge", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT        , "WeaponUsedEdge")));
  ...
  protected void checkType(_Fields setField, java.lang.Object value) throws java.lang.ClassCastException {
    switch (setField) {
      case ATTACK_PROPERTY:
        ...
        throw new java.lang.ClassCastException("Was expecting value of type AttackProperty for field 'attack_property', but got " + value.getClass().getSimpleName());
      case WEAPON_PROPERTY:
        if (value instanceof WeaponProperty) {
          break;
        }
        throw new java.lang.ClassCastException("Was expecting value of type WeaponProperty for field 'weapon_property', but got " + value.getClass().getSimpleName());
      case LOCATION_PROPERTY:
        if (value instanceof LocationProperty) {
          break;
        }
        throw new java.lang.ClassCastException("Was expecting value of type LocationProperty for field 'location_property', but got " + value.getClass().getSimpleName());
      case ATTACK_AT_EDGE:
        if (value instanceof AttackAtEdge) {
          break;
        }
        throw new java.lang.ClassCastException("Was expecting value of type AttackAtEdge for field 'attack_at_edge', but got " + value.getClass().getSimpleName());
      case WEAPON_USED_EDGE:
        if (value instanceof WeaponUsedEdge) {
          break;
        }
        throw new java.lang.ClassCastException("Was expecting value of type WeaponUsedEdge for field 'weapon_used_edge', but got " + value.getClass().getSimpleName());
      default:
  ...
  public AttackProperty getAttack_property() {
    if (getSetField() == _Fields.ATTACK_PROPERTY) {
      ...
      throw new java.lang.RuntimeException("Cannot get field 'attack_property' because union is currently set to " + getFieldDesc(getSetField()).name);
    }
  }
  ...
  public WeaponProperty getWeapon_property() {
    if (getSetField() == _Fields.WEAPON_PROPERTY) {
      ...
      throw new java.lang.RuntimeException("Cannot get field 'weapon_property' because union is currently set to " + getFieldDesc(getSetField()).name);
    }
  }
  ...
  public LocationProperty getLocation_property() {
    if (getSetField() == _Fields.LOCATION_PROPERTY) {
      ...
      throw new java.lang.RuntimeException("Cannot get field 'location_property' because union is currently set to " + getFieldDesc(getSetField()).name);
    }
  }
  ...
  public AttackAtEdge getAttack_at_edge() {
    if (getSetField() == _Fields.ATTACK_AT_EDGE) {
      ...
      throw new java.lang.RuntimeException("Cannot get field 'attack_at_edge' because union is currently set to " + getFieldDesc(getSetField()).name);
    }
  }
  ...
  public WeaponUsedEdge getWeapon_used_edge() {
    if (getSetField() == _Fields.WEAPON_USED_EDGE) {
      ...
      throw new java.lang.RuntimeException("Cannot get field 'weapon_used_edge' because union is currently set to " + getFieldDesc(getSetField()).name);
    }
  }
